...
<p id="p02">
	...
	<form action="<%=request.getContextPath()%>/ArticleServlet?action=deleteArticle&name=ano&value=<%=arts.getAno()%>" method="post">
						<input href="#" style="float: right" type="submit" value="删除"
					></form>
</p>
<p id="p03"><%=str%></p>
<p id="p04">
...
<ul >
	...
	<c:if test="<%=pageIndex%>>1 }" >
				<a href="../myspace/my_article2.jsp?pageIndex=1">首页&nbsp;</a>
				<a href="../myspace/my_article2.jsp?pageIndex=<%=pageIndex-1%>">上一页&nbsp;</a>
	</c:if>
	<c:if test="<%=pageIndex%> < <%=totalPage%> }" >
				<a href="../myspace/my_article2.jsp?pageIndex=<%=pageIndex+1%>">下一页&nbsp;</a>
				<a href="../myspace/my_article2.jsp?pageIndex=<%=totalPage%>">最后一页</a>
	</c:if>

 <form href="../myspace/my_article2.jsp">
 <span >跳转至
