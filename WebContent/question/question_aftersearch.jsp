...
<title>question_aftersearch</title>
...
<div id="div01">
			...
			<%
			String text = (String)request.getParameter("quetext");
				...
				<!-- 显示文章标题 -->
				<p id="p02">
					<a href="<%=request.getContextPath()%>/essay/essay_content.jsp"><strong style="font-size:130%"><%=art.getQtitle()%></strong></a>
				</p>
