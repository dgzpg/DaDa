...
<ul >
	...
	<c:if test="<%=pageIndex%>>1 }" >
				<a href="my_reply.jsp?pageIndex=1">首页&nbsp;</a>
				<a href="my_reply.jsp?pageIndex=<%=pageIndex-1%>">上一页&nbsp;</a>
	</c:if>
	<c:if test="<%=pageIndex%> < <%=totalPage%> }" >
				<a href="my_reply.jsp?pageIndex=<%=pageIndex+1%>">下一页&nbsp;</a>
				<a href="my_reply.jsp?pageIndex=<%=totalPage%>">最后一页</a>
	</c:if>


 <form href="my_reply.jsp">
 <span >跳转至
