...
<ul >
	...
	<c:if test="<%=pageIndex%>>1 }" >
				<a href="all_answer2.jsp?pageIndex=1">首页&nbsp;</a>
				<a href="all_answer2.jsp?pageIndex=<%=pageIndex-1%>">上一页&nbsp;</a>
	</c:if>
	<c:if test="<%=pageIndex%> < <%=totalPage%> }" >
				<a href="all_answer2.jsp?pageIndex=<%=pageIndex+1%>">下一页&nbsp;</a>
				<a href="all_answer2.jsp?pageIndex=<%=totalPage%>">最后一页</a>
	</c:if>


 <form href="all_answer2.jsp">
 <span >跳转至
	...
	<form action="<%=request.getContextPath()%>/replyservlet?action=toadd&qno=<%=qno%>" method="post">
		<p id="p03" style="font-size130%">写回复</p>
		<hr width=100% size="5" />
