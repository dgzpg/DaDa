...
<a href="javascript:;" id="btn" title="回到顶部"></a>
		...
		<li class="dropdown navbar-right">
			...
			<form action="<%=request.getContextPath()%>/homepage/afterSearch.jsp"class="navbar-form navbar-right" role="search">
...
<ul >
	...
	<c:if test="<%=pageIndex%>>1 }" >
				<a href="<%=request.getContextPath()%>/essay/all_essay2.jsp?pageIndex=1">首页</a>
				<a href="<%=request.getContextPath()%>/essay/all_essay2.jsp?pageIndex=<%=pageIndex-1%>">上一页</a>
	</c:if>
	<c:if test="<%=pageIndex%> < <%=totalPage%> }" >
				<a href="<%=request.getContextPath()%>/essay/all_essay2.jsp?pageIndex=<%=pageIndex+1%>">下一页</a>
				<a href="<%=request.getContextPath()%>/essay/all_essay2.jsp?pageIndex=<%=totalPage%>">最后一页</a>
	</c:if>


 <form href="all_essay2.jsp">
 <span>跳转至
