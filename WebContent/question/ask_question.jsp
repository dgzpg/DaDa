...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/write_essay.css">
</head>
</head>
...
<a href="javascript:;" id="btn" title="回到顶部"></a>
	...
	<ul id="ul02">
		...
		<li style="background-color: #48D1CC"><a
			href="<%=request.getContextPath()%>/question/ask_question.jsp" style="color:white" class="LeftTag">
				提&nbsp;&nbsp;&nbsp;&nbsp;问 </a></li>
	...
	<div id="div01">
		<form
			action="<%=request.getContextPath()%>/questionservlet?action=publishQuestion"
			method="post">
			<input id="div01_01" type="text" name="qtitle" placeholder="请输入问题标题"><br>
			<textarea id="div01_02" clos=",50" rows="5" warp="virtual"
				name="qtext" placeholder="请输入问题描述"></textarea>
			<p id="div01_03">问题分类</p>
			<select name="qtype" id="div01_04">
				<option>--请选择--</option>
				<option>辅修</option>
				<option>考研</option>
				<option>专业</option>
