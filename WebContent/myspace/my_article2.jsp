...
<body background="<%=request.getContextPath()%>/image/background.jpg">
	...
	<ul id="ul01" class="nav nav-tabs">
		...
		<li class="dropdown navbar-right">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1">
				...
				<li><a href="<%=request.getContextPath()%>/homepage/unlogin_homepage.jsp" tabindex="-1">注销</a>
				</li>
			</ul></li>
	...
	<ul id="ul02">
		...
		<li><a href="<%=request.getContextPath()%>/myspace/my_article.jsp"  class="LeftTag" style="background-color: #48D1CC;color: white;">我的文章</a>
		</li>
		...
		<div class="div01">
			...
			<%
			 ...
			 String sno="2016210001";
				...
				//每页显示的成员列表
				List<Article> list = art.getPageIntroductionList(pageIndex,pageSize,sno);
...
<p id="p02">
	...
	<a href="<%=request.getContextPath()%>/ArticleServlet?action=deleteArticle&name=ano&value=<%=arts.getAno()%>"
...
<ul >
	...
	<c:if test="<%=pageIndex%>>1 }" >
				<a href="../myspace/my_article.jsp?pageIndex=1">首页&nbsp;</a>
				<a href="../myspace/my_article.jsp?pageIndex=<%=pageIndex-1%>">上一页&nbsp;</a>
	</c:if>
	<c:if test="<%=pageIndex%> < <%=totalPage%> }" >
				<a href="../myspace/my_article.jsp?pageIndex=<%=pageIndex+1%>">下一页&nbsp;</a>
				<a href="../myspace/my_article.jsp?pageIndex=<%=totalPage%>">最后一页</a>
	</c:if>

 <form href="../myspace/my_article.jsp">
 <span >跳转至
