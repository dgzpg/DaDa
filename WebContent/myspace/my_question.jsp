...
%>
<p id="p02">
	<a href="<%=request.getContextPath()%>/question/question_content.jsp?name=<%=arts.getQno()%>"><strong style="font-size:130%"><%=arts.getQtitle()%></strong></a>
	<form action="<%=request.getContextPath()%>/questionservlet?action=deleteQuestion&name=ano&value=<%=Qno%>" method = "post">
					<input href="#" style="float: right" type="submit" value="删除"></form>
</p>
<p id="p03"><%=str%></p>
<p id="p04">
				<%=arts.getQtime()%>
...
<ul >
	...
	<c:if test="<%=pageIndex%>>1 }" >
				<a href="../myspace/my_question2.jsp?pageIndex=1">首页&nbsp;</a>
				<a href="../myspace/my_question2.jsp?pageIndex=<%=pageIndex-1%>">上一页&nbsp;</a>
	</c:if>
	<c:if test="<%=pageIndex%> < <%=totalPage%> }" >
				<a href="../myspace/my_question2.jsp?pageIndex=<%=pageIndex+1%>">下一页&nbsp;</a>
				<a href="../myspace/my_question2.jsp?pageIndex=<%=totalPage%>">最后一页</a>
	</c:if>

 <form href="../myspace/my_question2.jsp">
 <span >跳转至
