...
<ul >
	...
	<c:if test="<%=pageIndex%>>1 }" >
				<a href="<%=request.getContextPath()%>/question/all_question2.jsp?pageIndex=1">首页&nbsp;</a>
				<a href="<%=request.getContextPath()%>/question/all_question2.jsp?pageIndex=<%=pageIndex-1%>">上一页&nbsp;</a>
	</c:if>
	<c:if test="<%=pageIndex%> < <%=totalPage%> }" >
				<a href="<%=request.getContextPath()%>/question/all_question2.jsp?pageIndex=<%=pageIndex+1%>">下一页&nbsp;</a>
				<a href="<%=request.getContextPath()%>/question/all_question2.jsp?pageIndex=<%=totalPage%>">最后一页</a>
	</c:if>


 <form href="/question/all_question2.jsp">
 <span >跳转至
