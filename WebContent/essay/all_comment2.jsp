...
<ul >
	...
	<c:if test="<%=pageIndex%>>1 }" >
				<a href="all_comment.jsp?pageIndex=1">首页&nbsp;</a>
				<a href="all_comment.jsp?pageIndex=<%=pageIndex-1%>">上一页&nbsp;</a>
	</c:if>
	<c:if test="<%=pageIndex%> < <%=totalPage%> }" >
				<a href="all_comment.jsp?pageIndex=<%=pageIndex+1%>">下一页&nbsp;</a>
				<a href="all_comment.jsp?pageIndex=<%=totalPage%>">最后一页</a>
	</c:if>


 <form href="all_comment.jsp">
 <span >跳转至
